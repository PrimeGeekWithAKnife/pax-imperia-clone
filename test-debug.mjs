import { SHIP_COMPONENT_BY_ID, HULL_TEMPLATE_BY_CLASS } from './packages/shared/dist/data/ships/index.js';
import { validateDesign } from './packages/shared/dist/engine/ship-design.js';
