...
export interface BuildingDefinition {
  ...
  /** Waste produced per tick */
  wasteOutput: number;
  /** Happiness impact per tick (-10 to +10; negative = unhappy) */
...
export const BUILDING_DEFINITIONS: Record<BuildingType, BuildingDefinition> = {
  research_lab: {
    ...
    baseProduction: { researchPoints: 20 },
    buildTime: 90,
  ...
  population_center: {
    ...
    populationCapacityBonus: 1_500_000,
  },
  ...
  orbital_platform: {
    ...
    baseProduction: { energy: 5, credits: 3 },
    buildTime: 365,
    maintenanceCost: { credits: 2 },
    energyConsumption: 3,
    wasteOutput: 0.2,
  ...
  recycling_plant: {
    ...
    specialEffects: ['waste_reduction_25pct'],
  },
  ...
  military_academy: {
    ...
    specialEffects: ['troop_training', 'combat_bonus'],
  },
  ...
  medical_bay: {
    ...
    specialEffects: ['mortality_reduction', 'plague_resistance', 'troop_healing'],
  },
  ...
  advanced_medical_centre: {
    ...
    specialEffects: ['mortality_reduction', 'plague_resistance', 'troop_healing', 'gene_therapy'],
  },

  // ── Waste & environment infrastructure ──────────────────────────────────────
  ...
  waste_dump: {
    ...
    happinessImpact: -2,
    maxLevel: 5,
    description: 'A sealed containment area where industrial and domestic waste is stored in reinforced pits, buying the colony time before overflow becomes a crisis. Cheap and quick to erect, but finite — eventually, every dump fills up.',
    specialEffects: ['waste_storage_2000'],
  },
  ...
  waste_incinerator: {
    ...
    happinessImpact: -3,
    maxLevel: 5,
    description: 'A high-temperature furnace that reduces solid waste to ash, eliminating a fixed quantity each tick at the cost of atmospheric pollution. Effective but dirty — colonists complain about the smoke.',
    requiredTech: 'nanotechnology_basics',
    specialEffects: ['waste_elimination_3'],
  },

  atmosphere_cleanser: {
    name: 'Atmosphere Cleanser',
    baseCost: { credits: 150, minerals: 60 },
    baseProduction: {},
    buildTime: 180,
    maintenanceCost: { credits: 2 },
    energyConsumption: 3,
    ...
    happinessImpact: 2,
    maxLevel: 5,
    description: 'Massive air-processing towers that scrub pollutants from the atmosphere and convert accumulated waste into inert compounds. A clean solution that colonists actually welcome.',
    requiredTech: 'genetic_optimisation',
    specialEffects: ['waste_elimination_2', 'pollution_removal'],
  },

  orbital_waste_ejector: {
    name: 'Orbital Waste Ejector',
    baseCost: { credits: 300, minerals: 120, rareElements: 20 },
    baseProduction: {},
    buildTime: 365,
    maintenanceCost: { credits: 3 },
    energyConsumption: 4,
    ...
    happinessImpact: 0,
    maxLevel: 3,
    description: 'An orbital railgun that accelerates compacted waste packages to solar escape velocity, permanently removing them from the planetary ecosystem. The best solution money can buy — expensive, but the waste is simply gone.',
    requiredTech: 'gravity_generators',
    specialEffects: ['waste_elimination_5'],
  },

  energy_storage: {
    name: 'Energy Storage Facility',
    baseCost: { credits: 100, minerals: 40 },
    baseProduction: {},
    buildTime: 120,
    maintenanceCost: { credits: 1 },
    energyConsumption: 1,
    ...
    happinessImpact: 0,
    maxLevel: 5,
    description: 'Banks of high-capacity capacitors and superconducting coils that capture surplus energy for later use. Capacity scales dramatically with level: 50 / 150 / 500 / 1,500 / 5,000.',
    requiredTech: 'nanotechnology_basics',
    specialEffects: ['energy_storage'],
  },
  ...
  assimilation_node: {
    ...
    baseProduction: { researchPoints: 3 },
    buildTime: 14,
    maintenanceCost: { credits: 3 },
    energyConsumption: 2,
    wasteOutput: 0.2,
  ...
  dimensional_anchor: {
    ...
    baseCost: { credits: 300, minerals: 100 },
    baseProduction: { researchPoints: 6 },
    buildTime: 16,
    maintenanceCost: { credits: 4 },
    energyConsumption: 3,
    wasteOutput: 0.2,
  ...
  elemental_forge: {
    ...
    baseProduction: { minerals: 10, rareElements: 3 },
    buildTime: 12,
    maintenanceCost: { credits: 2 },
    energyConsumption: 3,
    wasteOutput: 2.0,
