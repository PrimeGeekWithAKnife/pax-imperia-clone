  ...
  return (
    <div className="top-bar">
      ...
      <div className="top-bar__actions" style={{ display: 'flex', gap: '4px', pointerEvents: 'auto' }}>
        {onOpenResearch && (
          <button className="speed-btn" onClick={onOpenResearch} title="Research (R)" data-tooltip="Research (R)">⚗ Research</button>
        )}
        {onOpenShipDesigner && (
          <button className="speed-btn" onClick={onOpenShipDesigner} title="Ship Designer (S)" data-tooltip="Ship Designer (S)">⚙ Ships</button>
        )}
        ...
        <button className="speed-btn" onClick={onOpenEspionage} title="Espionage (I)" data-tooltip="Espionage (I)">🕵 Espionage</button>
        {onOpenDiplomacy && (
          <button className="speed-btn" onClick={onOpenDiplomacy} title="Diplomacy (D)" data-tooltip="Diplomacy (D)">☮ Diplomacy</button>
        )}
      </div>
